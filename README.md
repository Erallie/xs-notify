...
![All-time Downloads](https://img.shields.io/github/downloads/Erallie/xs-notify/total?style=for-the-badge&label=All-time%20Downloads)
<br>
...
# Installation
1. Head over to the [latest release](https://github.com/Erallie/xs-notify/releases/latest).
